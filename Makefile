...
APP_DESCRIPTION   :=  The Same Game $(VERSION)
...
clean:
	...
	#delete icon and banner is better done in .bat file, 
	#otherwise create_banner has to be executed after every clean
	#@rm -fr $(RESOURCE)/*.icn $(RESOURCE)/*.bnr  
...
$(OUTPUT).cia: $(OUTPUT).elf 	../$(RESOURCE)/icon.icn		../$(RESOURCE)/banner.bnr
	$(MAKEROM) -f cia -o "$@" -elf $(OUTPUT).elf -rsf ../$(RESOURCE)/build-cia.rsf -icon ../$(RESOURCE)/icon.icn -banner ../$(RESOURCE)/banner.bnr -exefslogo -ver $(CIA_VER)


#---------------------------------------------------------------------------------
# rule for each extension used as binary data
#---------------------------------------------------------------------------------
%.bin.o	:	%.bin
#---------------------------------------------------------------------------------
	@echo $(notdir $<)
